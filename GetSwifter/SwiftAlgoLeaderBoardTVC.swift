...
class SwiftAlgoLeaderBoardTVC: UITableViewController,UIAlertViewDelegate{
    
    
    // URL to get details in JSON format
    let serviceEndPoint = "http://tc-leaderboard.herokuapp.com/getswifteralgos"
    ...
    override func tableView(tableView: UITableView?, cellForRowAtIndexPath indexPath: NSIndexPath?) -> UITableViewCell {
        let cell = tableView!.dequeueReusableCellWithIdentifier("swiftLeader", forIndexPath: indexPath!) as SwiftAlgoLeaderTableViewCell
